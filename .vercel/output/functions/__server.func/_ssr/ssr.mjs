...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CTiHP24A.mjs");
...
var manifest = {
	"7a5050eda2559b025c1ba2eed69f9a15cab896a4ac764a470710f047649134d2": {
		functionName: "fetchCatalog_createServerFn_handler",
		importer: () => import("./sheet-CqRtcjlO.mjs")
	},
	"dcfe2a71ac1f33c3d0121e9f9651356c6c9efe1351f6aa7e6e7567511ac5f63e": {
		functionName: "submitSheetOrder_createServerFn_handler",
		importer: () => import("./sheet-CqRtcjlO.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-8HaLVA_X.mjs").then((n) => n.t),
