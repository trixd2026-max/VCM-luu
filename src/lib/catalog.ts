...
export const LOCAL_PRODUCTS: Product[] = [
  // —— Trái cây vườn (thứ tự bán chạy theo chỉ định) ——
  {
    id: "sau-rieng",
    name: "Sầu riêng",
  ...
  {
    id: "dua-luoi-vang",
    name: "Dưa lưới vàng KieuFram",
    category: "trai-cay-vuon",
    price: 45_000,
    unit: "kg",
    description:
      "Dưa lưới vàng KieuFram vỏ vàng, thịt cam ngọt thơm. Trái đẹp, hay dùng trong giỏ biếu.",
    image: "/products/dua-luoi-vang.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "dua-luoi-xanh-t1",
    name: "Dưa lưới xanh T1 KieuFram",
    category: "trai-cay-vuon",
    price: 35_000,
    unit: "kg",
    description:
      "Dưa lưới xanh T1 KieuFram premium, thịt cam dày, ngọt đậm. Size lớn, phù hợp biếu tặng.",
    image: "/products/dua-luoi-xanh-t1.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "dua-luoi-xanh-t3",
    name: "Dưa lưới xanh T3 KieuFram",
    category: "trai-cay-vuon",
    price: 30_000,
    unit: "kg",
    description:
      "Dưa lưới xanh T3 KieuFram, thịt cam ngọt mát. Trái đều, đóng túi lưới — ăn tươi hoặc xếp giỏ.",
    image: "/products/dua-luoi-xanh-t3.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  ...
  },
  {
    ...
    unit: "giỏ",
    description:
      "Giỏ mây: dưa lưới, nho xanh, táo, cam. Gói màng kính, nơ xanh — kính cúng / biếu nhẹ.",
  ...
  {
    id: "gio-350",
    name: "Giỏ trái cây 350.000đ",
    category: "gio-trai-cay",
    price: 350_000,
    unit: "giỏ",
    description:
      "Giỏ mây: dưa lưới T-One, nho xanh, táo Jazz, lê, cam. Nơ xanh, gói sẵn.",
    image: "/products/gio-350k.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "gio-350-go",
    name: "Giỏ gỗ trái cây 350.000đ",
    category: "gio-trai-cay",
    price: 350_000,
    unit: "giỏ",
    description:
      "Giỏ gỗ tay cầm: dưa lưới Aladin, lê, cam, táo, nho xanh. Nơ tím — biếu lịch sự.",
    image: "/products/gio-350k-v2.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  ...
  {
    id: "gio-hoa-hong",
    name: "Giỏ hoa trái cây hồng 750.000đ",
    category: "gio-trai-cay",
    price: 750_000,
    unit: "giỏ",
    description:
      "Giỏ voan hồng, hoa hồng pastel kết nho, lê, cam, táo. Sinh nhật và biếu tặng.",
    image: "/products/gio-hoa-750k.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "gio-hoa-800",
    name: "Giỏ hoa trái cây 800.000đ",
    category: "gio-trai-cay",
    price: 800_000,
    unit: "giỏ",
    description:
  ...
  // —— Hộp quà (giá thấp → cao) ——
  {
    id: "hop-200",
    name: "Hộp quà trái cây 200.000đ",
    category: "hop-qua",
    price: 200_000,
    unit: "hộp",
    description:
      "Hộp mica nắp trong: nho xanh, táo đỏ, kiwi. Nơ Love At First Sight — sinh nhật, biếu.",
    image: "/products/hop-400k.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "hop-250",
    name: "Hộp quà trái cây 250.000đ",
    category: "hop-qua",
    price: 250_000,
    unit: "hộp",
    description:
      "Hộp mica nắp trong: nho xanh, táo, cam. Nơ hồng — biếu tặng, sinh nhật.",
    image: "/products/hop-500k.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "hop-300",
    name: "Hộp quà trái cây 300.000đ",
    category: "hop-qua",
    price: 300_000,
    unit: "hộp",
    description:
      "Hộp giấy Special Gift: lựu, nho xanh, kiwi, cam, táo. Kèm túi giấy — biếu gọn.",
    image: "/products/hop-300k.jpg",
    featured: true,
    inStock: true,
    discount: 0,
  },
  {
    id: "hop-qua-trai-cay",
    name: "Hộp quà trái cây 350.000đ",
    category: "hop-qua",
    price: 350_000,
    unit: "hộp",
    description:
